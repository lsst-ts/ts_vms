 ...
 */
static const char* const NiFpga_VMS_CameraRotator_Responder_Signature = "772509502E6A05D5CCD8307F62A2A166";
...
const NiFpga_FxpTypeInfo NiFpga_VMS_CameraRotator_Responder_IndicatorFxp_ChassisTemperature_TypeInfo =
{
   1,
   32,
   16
...
const uint32_t NiFpga_VMS_CameraRotator_Responder_IndicatorFxp_ChassisTemperature_Resource = 0x18034;
